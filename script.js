...
const correctAnswerFunc = () => {
    ...
    if (points < 12) {
        ...
        gameStatusContainer.innerHTML = `CONGRATULATIONS! <br/> You've become a Millionaire!`;
        pointsContainer.textContent = `You have earned $ ${points}00`;
...
const showQuestion = () => {
    ...
    questionContainer.textContent =
        data["games"][randomGameNum]["questions"][randomQuestionNum][
            "question"
        ];
};
